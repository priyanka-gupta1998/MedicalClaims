...
import com.hcl.medicalclaims.service.ClaimDetailsServiceImpl;
/* 
*@author priyanka
*/
...
public class ClaimDetailsControllerTest {
	...
	@InjectMocks
	ClaimDetailsController claimDetailsController;
	...
	public void getClaimDetailsTest()
	{
		 ...
		 Mockito.when(claimDetailsServiceImpl.getClaimDetails()).thenReturn(claimDetailsResponseDto);
		 claimDetailsResponseDto=claimDetailsController.getClaimDetails();
